...
//
//import com.bacbpl.iptv.jetStram.data.entities.MovieCategoryDetails
...
//import com.bacbpl.iptv.data.util.StringConstants.Movie.Reviewer.DefaultCount
//import com.bacbpl.iptv.data.util.StringConstants.Movie.Reviewer.DefaultRating
//import com.bacbpl.iptv.data.util.StringConstants.Movie.Reviewer.FreshTomatoes
//import com.bacbpl.iptv.data.util.StringConstants.Movie.Reviewer.ReviewerName
...
class MovieRepositoryImpl @Inject constructor(
    ...
    private val apiCategoryDataSource: ApiCategoryDataSource,  // Add this
    private val movieCastDataSource: MovieCastDataSource,
    private val movieCategoryDataSource: MovieCategoryDataSource,
) : MovieRepository {
    ...
    override fun getTVShows(): Flow<MovieList> = flow {
        // You can implement TV shows from API later
        emit(emptyList())
    }

    override fun getBingeWatchDramas(): Flow<MovieList> = flow {
        // You can implement Binge Watch Dramas from API later
        emit(emptyList())
    }
